                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-primary" data-toggle="modal"
                                                            data-target="#detailModal{{ $order['kode'] }}">
                                                            Detail <i class="bi bi-eye"></i>
                                                        </button>
                                                        <div class="modal fade" id="detailModal{{ $order['kode'] }}"
                                                    ...
                                                    <td>
                                                        <img class="img-fluid"
                                                            ...
                                                            data-target="#imageModal{{ $order['kode'] }}">
                                                        <div class="modal fade" id="imageModal{{ $order['kode'] }}"
                                                            tabindex="-1" aria-labelledby="exampleModalLabel"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-centered">
                                                                <div class="modal-content">
