...
<body>
    ...
    <div class="humberger__menu__wrapper">
        <div class="humberger__menu__logo">
            <a href="#"><img src="{{ url('templbuah/img/logo.png') }}" alt=""></a>
        </div>
        <div class="humberger__menu__cart">
            {{-- <ul>
                <li><a href="#"><i class="fa fa-heart"></i> <span>10</span></a></li>
                <li><a href="{{ url('layoutuser.cart') }}"><i class="fa fa-shopping-bag"></i>
                        <span>{{ $jumlah_pesanan }}</span></a></li>
            </ul> --}}
            <div class="header__cart__price">item: <span>$2828</span></div>
        </div>
        <div class="humberger__menu__widget">
            <div class="header__top__right__language">
                <img src="{{ url('templbuah/img/language.png') }}" alt="">
                <div>English</div>
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> HI</li>
                <li>Pengiriman Gratis Untuk Semua Pesanan Rp.99.999</li>
            </ul>
        </div>
    </div>
    <!-- Humberger End -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__auth">
                                <a href="{{ url('login') }}"><i class="fa fa-user"></i> @auth Hi,
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        ...
                        {{-- <div class="header__cart__price">item: <span>Rp. {{ number_format($subtotal) }}</span></div> --}}
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Makanan Laut</a></li>
                            <li><a href="#">Mentega & Telur</a></li>
                            <li><a href="#">Makanan Cepat Saji</a></li>
                            <li><a href="#">Bawang Segar</a></li>
                            <li><a href="#">Pepaya & Keripik</a></li>
                            <li><a href="#">Havermut</a></li> --}}
                        </ul>
                    </div>
                </div>
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg" data-setbg="{{ url('templbuah/img/hero/banner.jpg') }}">
        ...
        <div class="container">
            <div class="row">
                <div class="categories__slider owl-carousel">
                    <?php
                    $barang = DB::table('tbproduk')->get();
                    
                    foreach ($barang as $key => $value) {
                        # code...
                    ?>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="{{ asset('image/' . $value->foto) }}">
    ...
    <section class="featured spad">
        <div class="container">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            <li data-filter="">Buah</li>
                            <li data-filter="">Sayuran</li>
            ...
            <div class="row featured__filter">
                {{-- // Mengambil semua data dari tabel 'tbproduk' menggunakan Query Builder Laravel --}}
                <?php
                $barang = DB::table('tbproduk')->get();
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="{{ asset('image/' . $value->foto) }}">
                            <ul class="featured__item__pic__hover">
                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                <li><a href="{{ url('detail/' . $value->id) }}"><i class="icon_search"></i></a></li>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="banner__pic">
                        <img src="{{ url('templbuah/img/banner/banner-1.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="banner__pic">
                        <img src="{{ url('templbuah/img/banner/banner-2.jpg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic">
                            <img src="{{ url('templbuah/img/blog/blog-1.jpg') }}" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic">
                            <img src="{{ url('templbuah/img/blog/blog-2.jpg') }}" alt="">
                        </div>
                        <div class="blog__item__text">
                            <ul>
                                <li><i class="fa fa-calendar-o"></i> May 4,2019</li>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic">
                            <img src="{{ url('templbuah/img/blog/blog-3.jpg') }}" alt="">
                        </div>
                        <div class="blog__item__text">
                            <ul>
                                <li><i class="fa fa-calendar-o"></i> May 4,2019</li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__about__logo">
                            <a href="./index.html"><img src="{{ url('templbuah/img/logo.png') }}"
                                    alt=""></a>
                        </div>
                        <ul>
