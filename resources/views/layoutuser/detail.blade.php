            ...
            <ul>
                ...
                <li>
                    ...
                    <ul class="header__menu__dropdown">
                        <li>
                            <a href="{{ url('detail') }}">Shop Details</a>
                        </li>
                        <li>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        ...
                        {{-- <div class="header__cart__price">
                            item: <span>Rp. {{ number_format($subtotal) }}/span>
                        </div> --}}
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large" src="{{ asset('image/' . $rec->foto) }}"
                                alt="" />
                        </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price">Rp.{{ number_format($rec->harga_jual) }}</div>
                        <p>
                            {{ $rec->desc }}
                        </p>
                        <h3>
                            Stok : {{ $rec->saldo_akhir }}
                        </h3>
                        <div class="product__details__quantity">
                            <form action="{{ url('detail/') }}" method="POST">
                                @csrf
                                <input type="hidden" name="id_barang" value="{{ $rec->id }}">
                                <div class="quantity">
                                    <div class="pro-qty">
                                        <input type="number" id="jumlah_pesan" name="jumlah_pesan" value="1"
