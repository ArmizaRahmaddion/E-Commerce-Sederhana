                        ...
                        <div class="sidebar__item">
                            ...
                            <ul>
                                ...
                                @foreach ($categori as $item)
                                    <li><a href="{{ route('shop.kategori', $item->id) }}">{{ $item->nama }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg"
                                            data-setbg="{{ asset('image/' . $value->foto) }}">
                                            <div class="product__discount__percent">-20%</div>
                                            <ul class="product__item__pic__hover">
                                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                                <li><a href="{{ url('detail/' . $value->id) }}"><i
                                        ...
                                        <div class="product__discount__item__text">
                                            ...
                                            <div class="product__item__price">Rp.
                                                {{ number_format($value->harga_jual) }}</span></div>
                                        </div>
                                    </div>
                                </div>
                                <?php
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="product__item">
                                        <div class="product__item__pic set-bg"
                                            data-setbg="{{ asset('image/' . $item->foto) }}">
                                            <ul class="product__item__pic__hover">
                                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                        ...
                                        <div class="product__item__text">
                                            ...
                                            <h5>Rp. {{ number_format($item->harga_jual) }}</h5>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
