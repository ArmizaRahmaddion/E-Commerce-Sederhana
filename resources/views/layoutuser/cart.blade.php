    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__widget">
            ...
            {{-- <div class="header__top__right__auth">
                <a href="#"><i class="fa fa-user"></i>@auth Hi,
                                ...
                                @foreach ($products as $produk)
                                    ...
                                    <tr>
                                        <td class="shoping__cart__item">
                                            <img src="{{ asset('image/' . $produk->tbproduk->foto) }}"
                                                alt="">
                                            <h5>{{ $produk->tbproduk->nama }}</h5>
                                        </td>
                                        <td class="shoping__cart__price">
                                            {{ number_format($produk->tbproduk->harga_jual, 0, ',', '.') }}
                                        </td>
                                        <td class="shoping__cart__quantity">
                                            <form action="{{ route('cart.updateQuantity', ['id' => $produk->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('PUT')
                                                <div class="quantity">
                                        ...
                                        <td class="shoping__cart__total">
                                            {{ number_format($total_per_produk, 0, ',', '.') }}
                                        </td>
                                        <td class="shoping__cart__item__close">
                                            <form action="{{ route('cart.delete', ['id' => $produk->id]) }}"
                                                method="POST"
                                                ...
                                                <button type="submit" class="btn btn-danger">
                                                    ...
                                                    <!-- Ini adalah ikon trash dari Font Awesome -->
                                                </button>
                                            </form>
                                        </td>
